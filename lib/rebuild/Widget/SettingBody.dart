    ...
    return ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            trailing: Icon(Icons.keyboard_arrow_right, size: 25.0,), 
          ),
          ListTile(
          ...
          ListTile(
            leading: Icon(Icons.delete_sweep, size: 25.0,),
            title: Text('清理缓存', textAlign: TextAlign.left, style: TextStyle(fontSize: 15.0)),
            onTap: (){
